...
- (UIView *)getEmptyViewWithFrame:(CGRect)frame Tips:(NSString *)tip textColor:(UIColor *)color img:(NSString *)imgName
{
    ...
    CGSize aScreenSize = aEmptyView.frame.size;
    ...
    UILabel *aEmptyTipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, aEmptyImageView.frame.origin.y+aEmptyImageView.frame.size.height, aScreenSize.width, 15)];
